...
router.post("/", verifyTokenMiddleware, isAdminMiddleware, productController.createProduct);
router.patch("/:id", verifyTokenMiddleware, isAdminMiddleware, productController.updateProduct);
